...
OPENOCD_BOARD_DIR=/opt/openocd/share/openocd/scripts/board
...
deploy: all
	/opt/openocd/bin/openocd -f $(OPENOCD_BOARD_DIR)/stm32f3discovery.cfg -f $(OPENOCD_PROC_FILE) -c "stm_flash `pwd`/$(PROJ_NAME).bin" -c shutdown
